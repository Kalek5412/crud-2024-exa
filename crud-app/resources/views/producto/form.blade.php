<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            <label for="cantidad_stock" class="form-label">{{ __('Cantidad Stock') }}</label>
            <input type="text" name="cantidad_stock" class="form-control @error('cantidad_stock') is-invalid @enderror" value="{{ old('cantidad_stock', $producto?->cantidad_stock) }}" id="cantidad_stock" placeholder="Cantidad Stock">
            {!! $errors->first('cantidad_stock', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
